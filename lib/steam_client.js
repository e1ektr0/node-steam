...
SteamClient.prototype.connect = function(options) {
  ...
  this._options = {
    useSocks: false,
    customSocket: options.customSocket
  };
  console.log(options.customSocket)
  ...
  console.log(this._options.customSocket )
  this._connection = require('./connection')(this._options.useSocks,this._options.customSocket );
...
SteamClient.prototype._send = function(header, body, callback) {
  ...
  console.log("send"+this._connection)
  if(this._connection)
